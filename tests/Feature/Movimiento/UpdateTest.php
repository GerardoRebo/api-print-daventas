...
class UpdateTest extends TestCase
{
    ...
    public function test_()
    {
        ...
        // $this->assertDatabaseCount('v', 1);
    }
    //test 200 status only
    public function test_no_articulo()
    {
        $dbData = new DBData;
        $dbData->cargarDatos();
        $dbData->registerArticuloAzucar();
        ...
        // $response->dump();
        $response->assertStatus(500)->assertSee('No se encontro');
    }
    ...
    public function test_register_taxes_values()
    {
        ...
        $this->assertEquals(3.2, $articulo->impuestos_al_recibir);
    }
